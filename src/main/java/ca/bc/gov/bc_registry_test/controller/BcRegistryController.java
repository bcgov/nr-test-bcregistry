...
public class BcRegistryController {
  ...
  @GetMapping("/facets")
  public Flux<BcRegistryFacetSearchResultEntryDto> searchByFacets(
  ...
  public Mono<BcRegistryDocumentDto> getDocument(@PathVariable String identifier) {
    return service.requestDocumentData(identifier).next();
  }
