package ca.bc.gov.bc_registry_test.service.bcregistry;


import static ca.bc.gov.bc_registry_test.ApplicationConstant.BUSINESS_SUMMARY_FILING_HISTORY;

import ca.bc.gov.bc_registry_test.ApplicationConstant;
import ca.bc.gov.bc_registry_test.configuration.TestAppConfiguration;
...
import ca.bc.gov.bc_registry_test.exception.BadRequestException;
import ca.bc.gov.bc_registry_test.exception.InvalidAccessTokenException;
import ca.bc.gov.bc_registry_test.exception.NoClientDataFound;
import ca.bc.gov.bc_registry_test.exception.UnexpectedErrorException;
...
public class BcRegistryService {
  ...
  private BcRegistryPartyDto buildBcRegistryPartyDto(BcRegistryFacetPartyDto party) {
    ...
    Map<String, String> naming = parseName(party.partyName(), "BCREGISTRY");
  ...
  private Map<String, String> parseName(String displayName, String provider) {
    String[] nameParts =
